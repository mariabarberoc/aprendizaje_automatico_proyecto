...
El conjunto de datos combina infromación de canciones en dos de las platafromas más usadas Spotify y Youtube, con algunas características de audio como la energia, valance, etc. así como métricas para la popularidad en las dos plataformas, likes, comentarios, entre otras, que nos permite predecir la popularidad o analizar las tendencias musicale.
